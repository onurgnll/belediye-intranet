...
const { User, Telephone, DestekCevap, Duyuru, DuyuruResim, OgrenimDurumu, Mudurlukler, sequelize, Personel, Client, Destek } = require("../models");
...
const login = async (req, res, next) => {
    try {
        ...
        if (isUser.user_pass != password || isUser.user_name != username) {
